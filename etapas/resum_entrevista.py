...
def resumidor_entrevista():
    st.subheader('Resumidor de Entrevista')

    texto = st.text_area('Entrevista a ser resumida:', help="Digite/Cole aqui o texto a ser analisado", height = 300)
        ...
        if st.button('Resumir'):
            if 1 ==1:
                with st.spinner('Resumindo...'):
                    ...
                    - Resuma a entrevista se atentando aos padrões ortográficos e gramaticais da língua portuguesa brasileira de uma forma que mantenha o sentido do texto. Reescreva-a em formato de relatório.
                        """
